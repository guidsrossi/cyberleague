...
<body>
    ...
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="/img/programacao.jpg" class="d-block w-100 img-fluid" alt="...">
            <div class="carousel-caption d-none d-md-block">
              <h5>PROGRAMAÇÃO</h5>
              <p>Cursos de Lógica de Programação, Python, HTML, CSS, JavaScript e outros.</p>
            </div>
          </div>
          <div class="carousel-item">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="/img/cards/robotica.png" class="card-img-top" alt="Robótica">
                    <div class="card-body">
                        ...
                        <a href="courses.html#robotica" class="btn btn-warning mt-3"><strong>SABER MAIS</strong></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="/img/cards/informatica.png" class="card-img-top" alt="Informática">
                    <div class="card-body">
                        ...
                        <a href="courses.html#informatica" class="btn btn-warning"><strong>SABER MAIS</strong></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="/img/cards/programacao.png" class="card-img-top" alt="Programação">
                    <div class="card-body">
                        ...
                        <a href="courses.html#programacao" class="btn btn-warning"><strong>SABER MAIS</strong></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="/img/cards/design.jpg" class="card-img-top" alt="Design">
                    <div class="card-body">
                        ...
                        <a href="courses.html#design" class="btn btn-warning"><strong>SABER MAIS</strong></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="/img/cards/games.png" class="card-img-top" alt="Criação de Games">
                    <div class="card-body">
                        ...
                        <a href="courses.html#games" class="btn btn-warning mt-3"><strong>SABER MAIS</strong></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="/img/cards/profissionalizante.png" class="card-img-top" alt="Profissionalizantes">
                    <div class="card-body">
                        ...
                        <a href="courses.html#profissionalizantes" class="btn btn-warning"><strong>SABER MAIS</strong></a>                        
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5">
            ...
            <div class="text-center d-flex justify-content-center my-5">
                <iframe class="d-block d-md-none justify-content-center" width="350" height="200" src="https://www.youtube.com/embed/liszgatYWNk?si=Hr3i2uGvrvwf9LCE" title="Cyber League" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                <iframe class="d-none d-md-block justify-content-center" width="800" height="400" src="https://www.youtube.com/embed/liszgatYWNk?si=Hr3i2uGvrvwf9LCE" title="Cyber League" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
    </div>
